...
Geometry::Geometry(){
	...
	points[10] = vec4(0.5f, -1.0f, 0.5f, 1.0f);
	points[11] = vec4(0.5f, -1.0f, -0.5f, 1.0f);

	//left face
	points[12] = vec4(-0.5f, 1.0f, 0.5f, 1.0f);
	points[13] = vec4(-0.5f, 1.0f, -0.5f, 1.0f);
	points[14] = vec4(-0.5f, -1.0f, -0.5f, 1.0f);
	points[15] = vec4(-0.5f, -1.0f, 0.5f, 1.0f);
